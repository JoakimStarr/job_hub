...
export async function PUT(
  ...
  try {
    ...
    const { email, keywords, sources, locations, industries, education, exclude_keywords, enabled } = body;
    ...
    if (exclude_keywords !== undefined) updates.exclude_keywords = exclude_keywords;
